...
const RDPortfolio = () => {
  const budgetData = [
    { division: "Wayne Aerospace", allocated: 540, spent: 215, projects: 15 },
    { division: "Wayne Biotech", allocated: 676, spent: 245, projects: 15 },
    { division: "Applied Sciences", allocated: 634, spent: 156, projects: 15 },
    { division: "Wayne Construction", allocated: 456, spent: 145, projects: 12 },
    { division: "Wayne Foundation", allocated: 178, spent: 87, projects: 18 }
  ];
